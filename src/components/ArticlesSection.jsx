  ...
  useEffect(() => {
    async function fetchLatest() {
      const { data } = await supabase
        .from("articles")
        .select("id, title, tag, time, category, age_group, image_url")
        .not("content", "is", null)
      ...
      <div className="max-w-7xl mx-auto">
        ...
        {!loading && articles.length > 0 && (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {articles.map((a) => {
              const catColor =
                CAT_COLORS[a.category] ?? "bg-gray-50 text-gray-600";
                ...
                >
                  ...
                  <div className="h-40 relative overflow-hidden">
                    {a.image_url ? (
                      ...
                      <div
                        className={`w-full h-full bg-gradient-to-br ${catBg} flex items-center justify-center`}
                      >
                        <FontAwesomeIcon
                          icon={faBookOpen}
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-center justify-between mb-3">
                      <span
                        className={`flex items-center gap-1 text-xs font-semibold px-2.5 py-1 rounded-full ${catColor}`}
                      >
